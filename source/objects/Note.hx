...
class Note extends FlxSprite
{
	...
	**/
	...
	/** only used for holds, useful for correcting the segment height!**/
	public var renderHeight:Float = 0;

	/**
	 * should the note stretch the height to renderHeight?s
	 */
	public var useRenderHeight:Bool = false;

	// disable this if you want to use your own renderHeight
	public var autoRenderHeight:Bool = true;
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?createdFrom:Dynamic = null)
	{
		...
		if (isSustainNote && prevNote != null)
		{
			...
			var sc = PlayState.isPixelStage ? 6 : 0.7;
	...
	public function applyRenderHeight()
	{
		if (useRenderHeight)
		{
			setGraphicSize(frameWidth * scale.x, renderHeight);
		}
		updateHitbox();
		origin.y = offset.y = 0;
	}
